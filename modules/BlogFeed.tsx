    ...
    <div className={styles.wrapperFeed} ref={forwardRef}>
        <div className={styles.carouselCont}>
                ...
                <Carousel forwardRef={sliderRef}>
                    <CardBlog  himg={ '25%'} img={'/img/galeria.jpg'}/>
                    <CardBlog  himg={ '25%'} img={'/img/galeria-02.jpg'}/>
                    <CardBlog  himg={ '25%'} img={'/img/galeria-03.jpg'}/>
                    <CardBlog  himg={ '25%'} img={'/img/galeria-04.jpg'}/>
                    <CardBlog  himg={ '25%'} img={'/img/galeria-05.jpg'}/>
                    <CardBlog  himg={ '25%'} img={'/img/galeria-06.jpg'}/>
                </Carousel>
            </div>
    </div>
  )
